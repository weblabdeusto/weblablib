# -*- coding: utf-8 -*-
#
# weblablib documentation build configuration file, created by
...
htmlhelp_basename = 'weblablibdoc'
...
man_pages = [
    (master_doc, 'weblablib', u'weblablib Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'weblablib', u'weblablib Documentation',
     author, 'weblablib', 'One line description of project.',
     'Miscellaneous'),
]
